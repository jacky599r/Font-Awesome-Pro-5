...
document.addEventListener('DOMContentLoaded', function (_event) {
  [].concat(toConsumableArray(document.querySelectorAll('.fa'))).forEach(function (icon) {
    var iconClasses = classParser(icon);

    if (iconClasses.icon) {
      icon.outerHTML = make.apply(undefined, icons[iconClasses.icon].concat(iconClasses.rest));
    }
  });
});
